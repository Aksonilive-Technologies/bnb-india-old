...
const Invoice = () => {
  ...
  const handleDownload = async () => {
    ...
    if (!input) {
      console.error(
        "No input found! Ensure the ref is correctly attached to a DOM element.",
      );
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10">
        ...
        >
          ...
          <div className="relative z-10 flex flex-row justify-between items-start sm:items-center mb-6">
            <div className="text-sm sm:text-base">
              ...
              <p className="text-gray-700 max-w-[300px] sm:max-w-[400px]">
          ...
          {/* Invoice and Date */}
          <div className="bg-gray-200 shadow-md border border-gray-300 p-4 sm:p-5 rounded-lg mb-6 flex flex-col sm:flex-row sm:items-center justify-between text-sm sm:text-base">
            {/* Left Section */}
            <div className="mb-3 sm:mb-0">
              ...
              <p className="font-semibold text-gray-700">
                Booking ID: <span className="text-gray-900">{id}</span>
              </p>
            </div>
          ...
          <div className="relative z-10 mt-6 flex justify-center">
            <p className="text-gray-900 font-bold text-xl font-serif text-center">
              Thank you for choosing bnbIndia!
            </p>
          </div>
        </div>
      )}
      ...
      {
        !loading ?
        <button onClick={handleDownload} className="w-full mt-4 rounded-lg  max-w-3xl bg-black text-white py-2">
        download invoice
      </button>
      :
      null
