...
import { SlArrowRight, SlHeart, SlUser } from "react-icons/sl";
...
export default function Profile() {
  ...
  const settings = [
    ...
    {
      title: "Saved Villas",
      description: "View your saved villas",
      icon: <SlHeart size={22} />,
      href: "/profile/savedvillas",
    },
    {
      title: "My Bookings",
      description: "View your bookings",
      icon: <ImFolderUpload size={22} />,
      href: "/profile/mybookings",
    },
    // { title: 'Payments & payouts', description: 'Review payments, payouts, http://localhost:3214/profile/notificationscoupons and gift cards', icon: <SlCreditCard size={22} />, href: "/profile" },
  ...
  return (
    <div className="max-w-6xl mt-[1vh] mx-auto py-10 px-4 overflow-x-hidden sm:px-6 lg:px-8">
      {loading ? (
        ...
        <>
          <h1 className="text-2xl md:hidden md:text-4xl w-full font-bold">
            Profile
          </h1>
          ...
          <Link
            ...
            className="flex mt-6 md:hidden items-center p-6 bg-white rounded-lg border border-pink-600 shadow-md"
          >
            <div className="ml-4">
            ...
            {settings.map((setting, index) => (
              ...
              >
                <div className="flex items-center pt-1 justify-center">
                  <div className="h-full w-full md:w-12 md:h-12 text-gray-500">
                    {setting.icon}
                  </div>
                </div>
                <div className="flex-1 md:flex md:flex-col">
                  <h2 className="text-xl font-semibold md:font-bold ">
                    {setting.title}
                  </h2>
                  <p className="text-md hidden md:block text-gray-600">
                    {setting.description}
                  </p>
                </div>
                <div className=" md:hidden">
